...
@Component({
  selector: 'app-withdraw-balance-modal',
  templateUrl: './withdraw-balance-modal.component.html',
  styleUrls: ['./withdraw-balance-modal.component.scss']
})
export class WithdrawBalanceModalComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<WithdrawBalanceModalComponent>,
